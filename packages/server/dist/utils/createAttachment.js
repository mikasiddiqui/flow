...
const createFileAttachment = async (req) => {
    ...
    if (files.length) {
        ...
        for (const file of files) {
            ...
            const storagePath = await (0, flowise_components_1.addArrayFilesToStorage)(file.mimetype, fileBuffer, file.originalname, fileNames, chatflowid, chatId);
            ...
            try {
                ...
                throw new Error(`Failed operation: createFileAttachment - ${(0, utils_1.getErrorMessage)(error)}`);
            }
        }
    }
